...
export function ImportReviewDialog({
  ...
  onClose: () => void
  onReviewChange?: (state: { filename: string; review: ImportReview; selectedIndex: number | null; tagDraft: TagDraft }) => void
  ...
  useEffect(() => {
    if (filename && review) onReviewChange?.({ filename, review, selectedIndex, tagDraft })
  }, [filename, onReviewChange, review, selectedIndex, tagDraft])
        ...
        <div className="px-3 py-2.5">
          {loading ? (
            ...
            <div className="space-y-3">
              <div className="flex flex-wrap items-center justify-between gap-2 rounded-lg bg-zinc-900/20 px-2.5 py-2">
                <div className="flex items-center gap-2">
                  <SectionKicker>Discogs + Tags</SectionKicker>
                ...
                <div className="flex flex-wrap items-center justify-end gap-2">
                  <ActionButton size="xs" disabled={loading} onClick={() => { void handleRefresh() }}>
                    Refresh
                  </ActionButton>
