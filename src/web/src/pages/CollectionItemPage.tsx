...
export default function CollectionItemPage(): React.JSX.Element {
  ...
  const [busyAction, setBusyAction] = useState<'sync' | 'reanalyze' | 'mark-reanalyzed' | null>(null)
  ...
  const summary = useMemo(
    () => (item ? deriveTrackSummaryFromFilename(item.filename) : { artist: 'Unknown artist', title: 'Unknown title', year: '' }),
    [item]
  )
